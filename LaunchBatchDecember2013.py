...
data_folder = "/afs/cern.ch/eng/clic/TBData/DESY_TB_DATA_December2013_results/tbtrack"
result_folder = "/afs/cern.ch/eng/clic/TBData/DESY_TB_DATA_December2013_results/pyEudetAnalysis_plots"
LogFolder = "/afs/cern.ch/eng/clic/TBData/DESY_TB_DATA_December2013_results/pyEudetAnalysis_plots/launch/Logs"
pyEudetFolder = "/afs/cern.ch/eng/clic/TBData/DESY_TB_DATA_December2013_results/pyEudetNtuples"
Alignement_file =  ""
...
runs = range(2084,2104)+ range(2159,2184) + range(2296,2312) + range(2356,2364) + range(2365,2380)
...
if(options.STEP=="Alignment"):
    ...
    for method in method_names :
        for run in runs :
            ...
            Alignement_file =  "/afs/cern.ch/eng/clic/TBData/DESY_TB_DATA_December2013_results/Alignment/Alignment_Run%i.txt"%run
...
if(options.STEP=="Analysis"):
    ...
    for method in method_names :
        for run in runs :
            ...
            Alignement_file =  "/afs/cern.ch/eng/clic/TBData/DESY_TB_DATA_December2013_results/Alignment/Alignment_Run%i.txt"%run	    
            Alignement_file =  "/afs/cern.ch/eng/clic/TBData/DESY_TB_DATA_December2013_results/Alignment/Alignment_Run3208.txt"
