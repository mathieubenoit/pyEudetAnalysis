...
data_folder = "/afs/cern.ch/eng/clic/data/DESY_TB_DATA_19-30-08-2013_results/tbtrack"
result_folder = "/afs/cern.ch/eng/clic/data/DESY_TB_DATA_19-30-08-2013_results/pyEudetAnalysis_plots/Reprocessing_23_09_2013"
LogFolder = "/afs/cern.ch/eng/clic/data/DESY_TB_DATA_19-30-08-2013_results/pyEudetAnalysis_plots/launch/Logs"
pyEudetFolder = "/afs/cern.ch/eng/clic/data/DESY_TB_DATA_19-30-08-2013_results/pyEudetNtuples"
Alignement_file =  ""
...
runs_tmp = [x for x in runs if ( (x in range(48,67)) or (x in range(96,154)) or (x in range(155,184))) ]
