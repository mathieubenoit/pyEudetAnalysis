...
data_folder = "/afs/cern.ch/eng/clic/TBData/DESY_TB_DATA_February2014_results/tbtrack"
result_folder = "/afs/cern.ch/eng/clic/TBData/DESY_TB_DATA_February2014_results/pyEudetAnalysis_plots"
LogFolder = "/afs/cern.ch/eng/clic/TBData/DESY_TB_DATA_February2014_results/pyEudetAnalysis_plots/launch/Logs"
pyEudetFolder = "/afs/cern.ch/eng/clic/TBData/DESY_TB_DATA_February2014_results/pyEudetNtuples"
Alignement_file =  ""
...
if(options.STEP=="Alignment"):
    ...
    for method in method_names :
        for run in runs :
            ...
            Alignement_file =  "/afs/cern.ch/eng/clic/TBData/DESY_TB_DATA_February2014_results/Alignment/Alignment_Run%i.txt"%run
...
if(options.STEP=="Analysis"):
    ...
    for method in method_names :
        for run in runs :
            ...
            Alignement_file =  "/afs/cern.ch/eng/clic/TBData/DESY_TB_DATA_February2014_results/Alignment/Alignment_Run%i.txt"%run	    
            Alignement_file =  "/afs/cern.ch/eng/clic/TBData/DESY_TB_DATA_February2014_results/Alignment/Alignment_Run3208.txt"
